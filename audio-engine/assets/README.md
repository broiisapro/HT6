...
| `focused/` | Relaxed, feel-good, low-key positive | 3 |
| `dreamy/` | Upbeat, joyful | 3 |
| `energised/` | High-energy, gym/workout intensity | 4 |

Add more zone folders freely (e.g. `epic/`, `romantic/`) — nothing in the
code needs to change for a new one to be picked up.
...
| `focused/680134__seth_makes_sounds__fuzzy-lofi-synth-song.wav` | seth_makes_sounds | freesound.org/s/680134/ |
| `focused/826622__xkeril__memories-of-a-sweet-summer-music-loop.wav` | xkeril | freesound.org/s/826622/ |
| `focused/841204__venus17__melancholic-game-loop-the-night-city.wav` | venus17 | freesound.org/s/841204/ |
| `dreamy/517675__danlucaz__80s-loop-6.wav` | danlucaz | freesound.org/s/517675/ |
| `dreamy/673525__seth_makes_sounds__lofi-loop-2023.wav` | seth_makes_sounds | freesound.org/s/673525/ |
| `dreamy/830500__shaunhillyard__a-ukulele-tune.wav` | shaunhillyard | freesound.org/s/830500/ |
| `energised/365187__furbyguy__chill-liquid-trap-loop.wav` | furbyguy | freesound.org/s/365187/ |
| `energised/514280__danlucaz__eletro-hit-4.wav` | danlucaz | freesound.org/s/514280/ |
| `energised/race-song-loop-neko4444.mp3` | neko_4444 | freesound.org/people/neko_4444/sounds/739064/ |
| `energised/upbeat124-badoink.mp3` | BaDoink | freesound.org/people/BaDoink/sounds/573986/ |
